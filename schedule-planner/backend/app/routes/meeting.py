    ...
    try:
        ...
        if start_date_str:
            try:
                ...
                return jsonify(
                    {"code": 0, "message": "开始日期格式不正确，应为 YYYY-MM-DD"}
                ), 400
        ...
        if end_date_str:
            try:
                ...
                return jsonify(
                    {"code": 0, "message": "结束日期格式不正确，应为 YYYY-MM-DD"}
                ), 400
        ...
        return jsonify({"code": 0, "message": "服务器内部错误"}), 500
...
def create_new_meeting():
    ...
    try:
        ...
        if meeting:
            return jsonify({"code": 1, "message": message, "data": meeting})
        else:
            return jsonify({"code": 0, "message": message}), 400
...
def get_meeting_list():
    ...
    try:
        ...
        return jsonify({"code": 1, "message": message, "data": {"meetings": meetings}})
